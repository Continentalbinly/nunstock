...
import PaintColorTab from "@/components/PaintColorTab";
...
export default function PaintsPage() {
    ...
    // Top-level tab
    const [mainTab, setMainTab] = useState<"stock" | "colors">("stock");
    ...
    return (
        <div className="p-6 lg:p-8">
            {/* Top-level tab bar */}
            <div className="flex items-center gap-1 mb-6 p-1 rounded-xl w-fit" style={{ background: "var(--t-input-bg)", border: "1px solid var(--t-border-subtle)" }}>
                <button onClick={() => setMainTab("stock")} className="px-5 py-2 rounded-lg text-sm font-semibold transition-all cursor-pointer" style={mainTab === "stock" ? { background: "#8B5CF6", color: "white" } : { color: "var(--t-text-secondary)" }}>
                    <Palette className="w-4 h-4 inline mr-1.5" />คลังสี
                </button>
                <button onClick={() => setMainTab("colors")} className="px-5 py-2 rounded-lg text-sm font-semibold transition-all cursor-pointer" style={mainTab === "colors" ? { background: "#8B5CF6", color: "white" } : { color: "var(--t-text-secondary)" }}>
                    <Droplets className="w-4 h-4 inline mr-1.5" />เลขสี
                </button>
            </div>
